"""
DeepSpeed + OneCCL 3D Tensor Collectives Benchmarking Script
Benchmarks collective operations using DeepSpeed communication APIs with OneCCL backend
...
OUTPUT_DIR = "results/dsccl_direct_allreduce"
